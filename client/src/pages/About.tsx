...
export default function About() {
  return <div className="tw-root"><SiteHeader /><main>
    <section className="interior-hero" data-theme="dark"><div className="tw-container interior-hero__grid"><div><SectionEyebrow>About Technowiz</SectionEyebrow><h1 className="tw-display tw-display--xl">Your Vision. Built to Scale.</h1></div><p className="tw-lead">Technowiz delivers cutting-edge, scalable solutions for organisations worldwide — combining thoughtful consulting with hands-on software and enterprise-platform delivery.</p></div></section>
    ...
    <section className="hp-close" data-theme="dark"><div className="tw-container"><div><SectionEyebrow>Let’s see what is possible.</SectionEyebrow><h2 className="tw-display tw-display--lg">Bring your next challenge.</h2></div><a href="mailto:info@technowizltd.com?subject=TechnoWiz%20website%20enquiry" className="tw-btn tw-btn--mint">Start a conversation <ArrowUpRight /></a></div></section>
  </main><SiteFooter /></div>;
}
